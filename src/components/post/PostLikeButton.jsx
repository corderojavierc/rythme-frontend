...
export default function PostLikeButton() {
    ...
    // Verificamos si esta likeado. Algunos APIs devuelven is_liked y otros liked.
    // Usamos Boolean por claridad. Si el API devuelve 1 o "1" sera true, si es 0 o null sera false.
